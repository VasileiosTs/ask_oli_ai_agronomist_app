  ...
  render() {
    ...
    return (
      <div className="flex h-[100dvh] flex-col items-center justify-center gap-4 bg-background px-6 text-center">
        ...
        <div>
          <h2 className="mb-2 text-lg font-semibold text-foreground">Κάτι πήγε στραβά</h2>
          <p className="text-sm text-muted">Something went wrong. Please refresh the page.</p>
        </div>
        <button
