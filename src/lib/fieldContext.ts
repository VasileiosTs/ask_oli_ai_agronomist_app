/**
 * ⚠️  FRONTEND FILE — assembleFieldContext() IS NOT CALLED IN PRODUCTION.
 * All field context is assembled server-side in:
 *   supabase/functions/chat/lib/fieldContext.ts
 *
 * formatFieldContextBlock() is kept here only because fieldContext.test.ts
 * imports it.  If you remove the test, delete this entire file.
 *
 * Do NOT edit this file expecting it to affect what Oli says — it does not.
 */
