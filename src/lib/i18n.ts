...
const it: T = {
  ...
  organicTreatments: '🌿 Organici', chemicalTreatments: '⚗️ Chimici',
  logIt: 'Registra', logging: 'Registrazione...',
  cropType: 'Coltura', problem: 'Problema / Diagnosi', product: 'Prodotto',
...
const es: T = {
  ...
  organicTreatments: '🌿 Orgánicos', chemicalTreatments: '⚗️ Químicos',
  logIt: 'Registrar', logging: 'Registrando...',
  cropType: 'Cultivo', problem: 'Problema / Diagnóstico', product: 'Producto',
...
const fr: T = {
  ...
  organicTreatments: '🌿 Biologiques', chemicalTreatments: '⚗️ Chimiques',
  logIt: 'Enregistrer', logging: 'Enregistrement...',
  cropType: 'Culture', problem: 'Problème / Diagnostic', product: 'Produit',
...
const ar: T = {
  ...
  organicTreatments: '🌿 عضوي', chemicalTreatments: '⚗️ كيميائي',
  logIt: 'تسجيل', logging: 'جاري التسجيل...',
  cropType: 'المحصول', problem: 'المشكلة / التشخيص', product: 'المنتج',
...
export async function detectLang(): Promise<Lang> {
  ...
  if (manual && manual in dict) return manual;
