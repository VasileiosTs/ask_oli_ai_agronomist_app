    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-background p-4">
      <div className="w-full max-w-[420px] rounded-[16px] bg-surface p-8 shadow-xl border border-border">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="text-sm text-muted">O AI gewponos sou, panta dipla sou</p>
        </div>

        {sent ? (
          <div className="flex flex-col items-center text-center animate-fadeIn">
            <CheckCircle2 className="mb-4 h-12 w-12 text-primary" />
            <h2 className="mb-2 text-lg font-semibold text-foreground">Elegxte to email sas</h2>
            <p className="text-sm text-muted">
              Exoume steilei ena sindesmo eisodou sto {email}
            </p>
          </div>
        ) : (
          <div className="space-y-6 animate-fadeIn">
            <div className="space-y-3">
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-[22px] bg-white px-4 py-3 text-sm font-medium text-black transition-opacity hover:opacity-90"
              >
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-[22px] bg-[#1877F2] px-4 py-3 text-sm font-medium text-white transition-opacity hover:opacity-90"
              >
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-surface px-2 text-muted">i</span>
              </div>
            </div>
            ...
            <form onSubmit={handleMagicLink} className="space-y-4">
              ...
              >
                {loading ? 'Apostoli...' : 'Lipsi sindesmou eisodou'}
              </button>
            </form>
        ...
        <div className="mt-8 flex justify-center gap-4 text-xs text-muted">
          <Link to="/legal/terms" className="hover:text-foreground">Oroi Xrisis</Link>
          <span>-</span>
          <Link to="/legal/privacy" className="hover:text-foreground">Politiki Aporritoy</Link>
        </div>
      </div>
    </div>
  );
