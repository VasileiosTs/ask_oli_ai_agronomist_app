      ...
      <div className="w-full max-w-[420px] rounded-[16px] bg-surface p-8 shadow-xl border border-border">
        ...
        {sent ? (
          <div className="flex flex-col items-center text-center animate-fade-in">
            ...
            <h2 className="mb-2 text-lg font-semibold text-foreground">{t.checkEmailTitle}</h2>
            <p className="text-sm text-muted">{t.magicLinkSentTo} <strong>{email}</strong></p>
          </div>
        ) : (
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="pt-2 text-center">
              <button onClick={() => { loginAsGuest(); navigate('/chat'); }}
