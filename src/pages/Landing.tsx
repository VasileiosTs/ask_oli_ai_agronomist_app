...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#faf9f4] text-[#1b1c19] overflow-x-hidden" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      {/* Fonts loaded with preload + swap to avoid blocking first paint */}
      ...
      <link rel="preload" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&text=photo_camera%2Bpsychology%2Bwarning%2Beco%2Bcoronavirus%2Bbug_report%2Bwater_drop%2Bscience%2Bassignment_turned_in%2Bchat_bubble&display=swap" as="style" onLoad={(e) => { (e.target as HTMLLinkElement).rel = 'stylesheet'; }} />
      <noscript>
